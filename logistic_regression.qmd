...
Hay una cuestion con la altura que se registraron alturas de pacientes menores a 1m, lo cual es extraño. Se van a eliminar los datos de pacientes menores a 1m.
...
Por otro lado, respecto a la presion sistólica hay valores negativos y valores extremos para la vida humana. Dado esto y como en este caso no se puede consultar quien/quienes tomaron los datos, se decide eliminarlos del dataset.

Valores de presión sistólica y diastólica que no son compatibles con la vida:

- Presión sistólica: > 190 mmHg o < 90 mmHg.
- Presión diastólica: > 150 mmHg o < 40 mmHg.

A continuación se muestran los datos que se eliminaron.
